...
const Footer = () => {
  return (
    <footer className="border-t border-gray-300 bg-cream md:mt-32 md:px-10">
      <Link href="/">
        <a className="block md:pt-20">
          <Image
            src="/artshublogo.svg"
            alt="ArtsHub Logo"
            width={96}
      ...
      <div className="flex items-start md:pt-20">
        <div className="flex flex-1 md:space-x-12">
          <div className="">
            <span className="text-sm uppercase">WORKS</span>
            <div className="pt-4">
              {works.map((work) => (
                <a
                  href={work.link}
                  target="_blank"
                  className="block py-1 text-xl"
                  key={work.title}
                  rel="noreferrer"
                >
                  {work.title}
          ...
          <div className="">
            ...
            <div className="pt-4">
              <a href="a" target="_blank" className="block py-1 text-xl">
                wiz@gmail.com
              </a>
              {socials.map((social) => (
                <a
                  href={social.link}
                  target="_blank"
                  className="flex items-center space-x-2 py-1 text-xl"
                  key={social.title}
                  rel="noreferrer"
                >
        ...
        <span className="block flex-1 text-[128px] font-medium">ARtsHub</span>
      </div>
      <div className="flex items-center space-x-5 pb-5 md:pt-10">
        <span className="block text-sm">
          Copyright © 2022 ArtsHub. All rights reserved.
        </span>
